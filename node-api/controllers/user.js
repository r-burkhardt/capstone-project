...
exports.setDBConnectionsFromApp = (app) => {
  collection = app.get( 'db' ).collection( 'user' );
}
...
exports.getUser = (req, res) => {
  ...
  collection.findOne( { "_id": objID }, (err, user) => {
    res.type( 'application/json' );
...
exports.createUser = (req, res) => {
  ...
  collection.insertOne( newUser, (err, returnUser) => {
    res.type( 'application/json' );
...
exports.deleteUser = (req, res) => {
  ...
  collection.remove( { "_id": objID }, (err, status) => {
    res.type( 'application/json' );
